...
variable "http_listeners" {
  description = "A list of maps describing the HTTP listeners or TCP ports for this ALB. Required key/values: port, protocol. Optional key/values: target_group_index (defaults to http_listeners[count.index])"
  type        = any
  default     = []
}
...
variable "http_listener_rules" {
  description = "A list of maps describing the Listener Rules for this ALB. Required key/values: actions, conditions. Optional key/values: priority, http_listener_index (default to http_listeners[count.index])"
  type        = any
  default     = []
}
...
variable "subnets" {
  ...
  type        = list(string)
  default     = [
  "subnet-03969d7d019aec1ac",
  "subnet-0a9f46d4d48e23b5f",
  "subnet-038b43f16d36af955",
]
}
...
variable "http_listener_rules_tags" {
